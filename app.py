...
with ui.sidebar(open='open'):
    ...
    #   the label for the input (in quotes)
    ui.input_numeric("plotly_bin_count","Bin Count",5)
    ...
    ui.input_slider("seaborn_bin_count","Bin Count",0,20,5)
    ...
    ui.input_checkbox_group("selected_species_list","Species",["Adelie", "Gentoo", "Chinstrap"],selected=["Adelie", "Gentoo", "Chinstrap"],inline=True)
    ...
    ui.a("My GitHub Repo",href="https://github.com/nhansen23/cintel-02-data",target="_blank")
